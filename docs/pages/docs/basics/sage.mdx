...
```js showLineNumbers filename="/src/commands/hello.js" /content/
...
```js showLineNumbers filename="/src/commands/hello.js" {2}
export default () => {
...
```js showLineNumbers filename="/src/commands/hello.js" /Sage/
...
```js showLineNumbers filename="/src/commands/hello.js" /deferReply/
...
```js showLineNumbers filename="/src/commands/hello.js"
...
```js showLineNumbers filename="/src/commands/whooooops.js" /undefinedVariable/
export default () => {
...
```js showLineNumbers filename=".config/robo.mjs" /sage/
export default {
