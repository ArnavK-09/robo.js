...
```ts {1} filename="/src/commands/command.ts" /CommandResult/ /CommandConfig/ showLineNumbers
...
```ts /CommandInteraction/ filename="/src/commands/ts-command.ts" showLineNumbers
...
```js showLineNumbers /@type/ filename="config/robo.mjs"
// @ts-check
...
```json showLineNumbers filename="tsconfig.json" {4-7}
{
...
```ts /@/ showLineNumbers filename="/src/commands/easy-peasy.ts"
// Before
...
<FileTree>
	<FileTree.Folder name="my-monorepo" open>
		<FileTree.Folder name="packages" open>
			<FileTree.Folder name="robo" open>
				<FileTree.Folder name=".robo"></FileTree.Folder>
				<FileTree.Folder name="src"></FileTree.Folder>
				<FileTree.File name="package.json" />
			</FileTree.Folder>
			<FileTree.Folder name="api" open>
				<FileTree.Folder name="dist"></FileTree.Folder>
				<FileTree.Folder name="src"></FileTree.Folder>
				<FileTree.File name="package.json" />
			</FileTree.Folder>
		</FileTree.Folder>
