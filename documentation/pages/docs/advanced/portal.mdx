...
<Callout type="info">
	🔔 **Friendly reminder:** Changes you make through the Portal are as fleeting as dreams. They're alive and kicking
	while your Robo's running, but once it restarts, poof—they're gone. Keep that in mind when you're playing around in
	there!
</Callout>
...
```js showLineNumbers filename="/src/events/_start.js" /portal/
import { portal } from '@roboplay/robo.js'
