...
```js showLineNumbers filename="commands/ping.js"
export default () => {
	return 'Pong!'
}
```
...
```js showLineNumbers filename="commands/ping.js" {2}
          ...
          <FileTree.Folder name="src" open>
              <FileTree.Folder name="commands" open>
                  <FileTree.Folder name="ban" open>
                      <FileTree.File name="user.js" active />
                      </FileTree.Folder>
                  </FileTree.Folder>
              </FileTree.Folder>
          </FileTree>
              ...
              <FileTree.Folder name="commands" open>
                  <FileTree.Folder name="settings" open>
                      <FileTree.Folder name="update" open>
                          <FileTree.File name="something.js" active />
                          </FileTree.Folder>
                      </FileTree.Folder>
                  </FileTree.Folder>
              </FileTree.Folder>
...
```js showLineNumbers filename="commands/ping.js" {3-9}
export const config = {
  description: 'Responds with Pong!',
  options: [
    {
