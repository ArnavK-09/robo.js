...
```sh /create-robo/ filename="Terminal"
...
<Callout type="info">Don't forget to replace `[projectName]` with your desired name for your new Robo.</Callout>
...
<Callout type="info">
	You can summon **Sage** in the documentation site at any time by pressing *Command + K* or *Control + K*.
</Callout>
